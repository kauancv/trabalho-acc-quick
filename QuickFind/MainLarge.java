...
public class MainLarge {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Scanner sc = new Scanner(new File("arquivosdeteste\\large.txt"));

        int n = sc.nextInt();

        QuickFindUF uf = new QuickFindUF(n);

        PrintWriter writer = new PrintWriter(new FileWriter("large_quickfind.csv"));
        ...
        System.out.println("Large finalizado!");
    }
}