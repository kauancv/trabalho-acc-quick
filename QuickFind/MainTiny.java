...
public class MainTiny {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Scanner sc = new Scanner(new File("arquivosdeteste\\tiny.txt"));

        int n = sc.nextInt();

        QuickFindUF uf = new QuickFindUF(n);

        PrintWriter writer = new PrintWriter(new FileWriter("tiny_quickfind.csv"));
        ...
        System.out.println("Tiny finalizado!");
    }
}